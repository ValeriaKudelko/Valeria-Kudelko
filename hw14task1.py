...
def process_students_data():
    try:
        ...
        with open("students.txt", "r", encoding="utf-8") as file:
            ...
            total_students = 0  # pylint: disable=invalid-name
            group_counts = {}
            group_averages = {}
            for line in lines:
                name, group, grade = line.split(",")  # pylint: disable=unused-variable # noqa: E501
                total_students += 1  # pylint: disable=invalid-name
                group_counts[group] = group_counts.get(group, 0) + 1
                group_averages[group] = group_averages.get(group, 0) + int(grade)  # noqa: E501 # pylint: disable=line-too-long
